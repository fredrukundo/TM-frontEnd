  ...
  const handleImageUpload = async () => {
    ...
    const  imageResult = await ImagePicker.launchImageLibraryAsync();
      if (!imageResult.canceled) {
        setPassport(imageResult.assets[0].uri);
      }
  ...
  return (
    ...
    <ScrollView>
      ...
      <View style={styles.content}>
        ...
        {/* Passport section */}
        <Text style={styles.sectionLabel}>Passport photo</Text>
        <View style={styles.section}>
          ...
          >
            {Passport ? (
              <Image source={{ uri: Passport }} style={styles.uploadedImage} />
            ) : (
                <>
                <Fontisto name="passport-alt" size={40} color="gray" />
