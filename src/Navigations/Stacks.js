...
import { Entypo,MaterialCommunityIcons,MaterialIcons,AntDesign,Ionicons } from '@expo/vector-icons';
  ...
  return (
    ...
    >
      ...
      tabBarIcon: ({focused}) => focused ? (
        <MaterialCommunityIcons name="airplane" size={27} color="#dc661f" />
      ):(
        <MaterialCommunityIcons name="airplane-marker" size={27} color={activeColors.TextColor} /> 
      )
    }}
       />
      <Tab.Screen 
    ...
    tabBarIcon: ({focused}) => focused ? (
      ...
      tabBarLabel: 'Message',
    tabBarIcon: ({focused}) => focused ? (
      <MaterialCommunityIcons name="message-processing" size={27} color="#dc661f" />
      ):(
        <MaterialCommunityIcons name="message-processing-outline" size={27} color={activeColors.TextColor} />
      )
    }}
       />
      <Tab.Screen 
